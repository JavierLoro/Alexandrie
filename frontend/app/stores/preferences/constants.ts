...
export const DEFAULT_PREFERENCES = {
  ...
  snippets: [
    ...
    { id: '!info-red', label: ':::info-red\n${0}\n:::' },
    { id: '!info-blue', label: ':::info-blue\n${0}\n:::' },
    { id: '!info-teal', label: ':::info-teal\n${0}\n:::' },
    { id: '!center', label: ':::center\n${0}\n:::' },
    { id: '!columns', label: ':::columns\n${0}\n:::' },
    { id: '!column', label: ':::column\n${0}\n:::' },
    { id: '!no-print', label: ':::no-print\n${0}\n:::' },
    { id: '!property', label: ':::property ${0}\n\n:::' },
    { id: '!warning', label: ':::warning ${0}\n\n:::' },
    { id: '!frame', label: ':::frame ${0}\n\n:::' },
    { id: '!card', label: ':::card ${0}\n\n:::' },
    { id: '!pannel', label: ':::pannel ${0}\n\n:::' },
  ] as ANode<string>[],

<template>
  <aside>
    ...
    <ul v-if="!hideToc" ref="list" style="position: relative">
...
// `hideToc`: oculta el índice (no aplica a docs HTML, cuyos headings viven en el iframe);
// la barra sigue mostrando tags e hijos.
const props = defineProps<{ element?: HTMLElement; doc?: Node; hideToc?: boolean }>();
